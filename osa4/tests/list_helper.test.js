...
describe('total likes', () => {
  ...
  test('when list has multiple blogs total sum of likes is returned', () => {
...
describe('favorite blog', () => {
  ...
  test('when list has multiple blogs, one with most likes is returned', () => {
    expect(listHelper.favoriteBlog(blogs)).toEqual(blogs[2])
  })

  test('when list is empty, empty object is returned', () => {
...
describe('most blogs', () => {
  ...
  test('when list has only one blog, that author and count 1 is returned', () => {
    expect(listHelper.mostBlogs(listWithOneBlog)).toEqual({ author: 'Edsger W. Dijkstra', blogs: 1 })
  })

  test('when list has multiple blogs, author with most blogs and correct count is returned', () => {
...
describe('most likes', () => {
  ...
  test('when list has only one blog, that author and count of likes is returned', () => {
    expect(listHelper.mostLikes(listWithOneBlog)).toEqual({ author: 'Edsger W. Dijkstra', likes: 5 })
  })

  test('when list has multiple blogs, author with most likes and count is returned', () => {
